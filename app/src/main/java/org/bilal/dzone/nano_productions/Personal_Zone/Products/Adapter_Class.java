...
public class Adapter_Class extends RecyclerView.Adapter<Adapter_Class.RvViewHolder>{
    ...
    Context context;
    ArrayList<Model_Class> modelClasses;


    public Adapter_Class(Context context, ArrayList<Model_Class> modelClasses){
    ...
    View view;
    @Override
    public Adapter_Class.RvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final Adapter_Class.RvViewHolder holder, final int position) {
        final Model_Class modelClass = modelClasses.get(position);
